...
export interface ApiAddressAddress extends Schema.CollectionType {
  ...
  attributes: {
    ...
    zipeCode: Attribute.Integer & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiHeaderBannerHeaderBanner extends Schema.CollectionType {
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    paymentStatus: Attribute.String & Attribute.Required;
    isApprove: Attribute.Boolean & Attribute.Required;
    paymentMethod: Attribute.String;
    date: Attribute.DateTime & Attribute.Required;
    optimumtime: Attribute.Date;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProductCategoryProductCategory
  ...
  attributes: {
    collectionName: Attribute.String &
      Attribute.Required &
      Attribute.SetMinMaxLength<{
        minLength: 5;
        maxLength: 100;
...
export interface ApiProductPromotionProductPromotion
  extends Schema.CollectionType {
  collectionName: 'product_promotions';
  info: {
    singularName: 'product-promotion';
    pluralName: 'product-promotions';
    displayName: 'productPromotion';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::product-promotion.product-promotion',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiSocilaMediaSocilaMedia extends Schema.CollectionType {
  collectionName: 'socila_medias';
  info: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::product-promotion.product-promotion': ApiProductPromotionProductPromotion;
      'api::review.review': ApiReviewReview;
      'api::socila-media.socila-media': ApiSocilaMediaSocilaMedia;
